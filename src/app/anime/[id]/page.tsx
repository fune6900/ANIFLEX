...
import { getAnimeDetail, getImageUrl } from "@/lib/tmdb";
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
              {cast.map((member) => (
                <div key={member.id} className="text-center">
                  <div className="relative w-full aspect-square rounded-full overflow-hidden bg-gray-800 mb-2 mx-auto max-w-[72px]">
                    {member.profile_path ? (
                      <Image
                  ...
                  <p className="text-white text-[11px] font-semibold truncate">{member.name}</p>
                  {member.character && (
